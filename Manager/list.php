    ...
    <table border="1"> 
        ...
        ?> 
                ...
                <tr> 
                    ...
                    <td colspan="2"> 
                        <a href="updatecar.php?produk=<?php echo $row["idproduk"]; ?>">Update</a> 
                        <a href="deletecar.php?produk=<?php echo $row["idproduk"]; ?>" onclick="return confirm('Are you sure to delete?')">Delete</a> 
                    </td> 
                </tr> 
